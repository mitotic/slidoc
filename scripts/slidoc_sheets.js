...
//  1. Navigate to drive.google.com and click on NEW > Google Sheets to create a new blank Sheet.
//     Rename it to your SITE_NAME (usually course/project name)
//
...
//
//  3. Click Run and select "setup"
//     It should show 'Preparing for execution’ and then put up a dialog 'Authorization Required ...’.
//     Select 'Review permissions'
//     Select your Google account
//     When you see the dialog 'Slidoc wants View manage spreadsheets ... data ... Send email’
//     Click ALLOW button (may need to scroll down to see it)
//     Then you should see "Running function setup"
//
//  4. Go back to spreadsheet window. The previous setup step should have created a sheet named 'settings_slidoc'. In this sheet,
//       set 'auth_key' to your secret site key  (Generated by sliauth.py -a root_key -t SITE_NAME)
//       set 'server_url' to the base URL of the web server. e.g., https://slidoc.org
//       set 'site_name' to the site name (to be appended to the base URL to access the site)
//       set 'site_label' to a short, but more human-readable version of the name (with spaces etc.)
//       set 'site_title' to a longer, descriptive title for the site
//       set 'admin_users' to comma-separated list of admin userids
//       set 'share_averages' to 'yes' if class averages for tests should be shared.
//
//  5. Go to Slidoc script window. Select File->Manage Versions…
//     We need to save a version of the script for it to be executed.
//     In the box labeled 'Describe what has changed’ type 'Initial version’ and click on 'Save new version button
...
//     For 'Execute the app as:’ leav as set to 'Me’.
//     For 'Who has access to the app:’ select 'Anyone, even anonymous’.
//     Click the 'Deploy’ button.
//     This project is now deployed as a web app.
//     Copy the 'Current web app URL' from the dialog, and then click OK
//     (This URL will be used by the Slidoc web server to remotely execute the script)
//
//  8. If you make any further changes to this script, Save it and then select on Publish->Deploy as web app…
//     Change Project Version to New and click Update (the web app URL remains the same)
//     (If you changed the Slidoc menu, you may need to close the spreadsheet and re-open it to see the modified menu.)
//
//
