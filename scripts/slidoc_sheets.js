...
var DEFAULT_SETTINGS = [ ['auth_key', 'testkey', 'Secret value for secure administrative access (obtain from proxy for multi-site setup: sliauth.py -a root_key -t site_name)'],
			 ...
			 ['gradebook_enabled', '', 'Non-null string to enable gradebook sheet'],
...
//    - set `auth_key` to your secret site key  (Generated by terminal command `sliauth.py -a root_key -t SITE_NAME`)
...
//    - set `gradebook_enabled` to `yes` to enable gradebook sheet
// 
// 5. Go to the script window. Select `File->Manage Versions...`
