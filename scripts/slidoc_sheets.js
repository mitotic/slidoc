...
//    To initialize these settings, select Initialize settings from the Slidoc menu:
//        - Enter site name
//        - Enter root key, if known, or blank and then site key
//    This will set `auth_key` to your secret site key  (can also be generated by terminal command `sliauth.py -a ROOT_KEY -t SITE_NAME`)
// 
